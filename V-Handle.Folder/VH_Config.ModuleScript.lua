...
Config.AnnounceJoin = true

-- If true the admin will print when a player leaves to the chat
Config.AnnounceLeft = true

-- How often the admin checks for updates in seconds ( Must be at least 30 and at most 1800 )
Config.UpdatePeriod = 60

-- Override properties of commands like UserPower or Category
-- --Examples--
-- Config.CommandOptions = { Kill = { UserPower = "user" } } - Allows users to use the Kill command
