return function(Group)
	...
	ErrorTests:AddTest{Name = "invalid_arg_format", Function = ExtendedTranslations.Translate, Args = {"en-us", "PrecedingZeros", {Num = "Fake"}}, ExpectedError = "invalid argument #2 to 'format' (number expected, got string)", FailMsg = "Didn't error for invalid argument for format type"}
